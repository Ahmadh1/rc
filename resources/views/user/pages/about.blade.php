...
@section('theme')
        ...
        <section class="section section-bg-edge">
            ...
            <div class="image left bottom col-md-7">
                <div class="bg-image"><img src="{{ asset('theme/img/photos/bg-chef.jpg') }}" alt=""></div>
            </div>
            ...
            <div class="container">
                <div class="col-lg-5 push-lg-5 col-md-9 push-md-3">
                    ...
                    <img src="{{ asset('theme/img/svg/sign.svg') }}" alt="" class="mb-5">
        ...
        <section class="section section-lg dark bg-dark">
            ...
            <div class="container text-center">
                <div class="col-lg-8 push-lg-2">
                    ...
                    <a href="{{ url('/menu') }}" class="btn btn-primary"><span>Order Online</span></a>
