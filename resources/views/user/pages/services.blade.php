	 ...
	 <!-- Page Title -->
        ...
        <section class="section section-double">
            <div class="row no-gutters">
                ...
                <div class="image col-xl-8 col-md-7">
                    <div class="bg-image"><img src="{{ asset('theme/img/photos/service-weddings.jpg') }}" alt=""></div>
                </div>
            </div>
        </section>
        ...
        <section class="section section-double">
            <div class="row no-gutters">
                ...
                <div class="image col-xl-8 col-md-7 pull-xl-4 pull-md-5">
                    <div class="bg-image"><img src="{{ asset('theme/img/photos/service-engagement.jpg') }}" alt=""></div>
                </div>
            </div>
        </section>
        ...
        <section class="section section-double">
            <div class="row no-gutters">
                ...
                <div class="image col-xl-8 col-md-7">
                    <div class="bg-image"><img src="{{ asset('theme/img/photos/service-birthday.jpg') }}" alt=""></div>
                </div>
            </div>
        </section>
