            ...
            <div class="container">
                ...
                <div class="carousel" data-slick='{"dots": true}'>
                    ...
                    <div class="special-offer">
                        <img src="{{ asset('theme/img/photos/special-burger.jp') }}g" alt="" class="special-offer-image">
                    ...
                    <!-- Special Offer -->
                    <div class="special-offer">
                        <img src="{{ asset('theme/img/photos/special-pizza.jpg') }}" alt="" class="special-offer-image">
                        <div class="special-offer-content">
                    ...
                    <!-- Special Offer -->
                    <div class="special-offer">
                        <img src="{{ asset('theme/img/photos/special-dish.jpg') }}" alt="" class="special-offer-image">
                        <div class="special-offer-content">
